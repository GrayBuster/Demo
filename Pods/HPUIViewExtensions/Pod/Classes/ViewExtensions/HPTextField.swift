...
public class HPTextField: UITextField {
    ...
    @IBInspectable public var placeholderColor: UIColor? {
        didSet {
            let holderStr = NSAttributedString(string: self.placeholder!, attributes: [kCTForegroundColorAttributeName as NSAttributedStringKey: self.placeholderColor!])
...
@IBDesignable
public class MyTextField: HPTextField {
